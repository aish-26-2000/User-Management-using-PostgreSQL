        ...
        body: Joi.object().keys({
            ...
            cannabis_related_details: {
                license_type: Joi.string()
                    ...
                    .required(),
                license_no: Joi.string().min(3).max(50).required(),
                licensed_country: Joi.string().valid('Canada', 'United States of America').required(),
                licensed_state: Joi.when('licensed_country', {
                    is: 'Canada',
                    then: Joi.string()
                        .valid(
                            'Alberta',
